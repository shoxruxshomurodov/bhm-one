...
function BranchPurposePage(props) {
                        ...
                        <ul className="nav">
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-warning">{get(meta,"purposive.newCount")}</b></span>
                                </a>
                            </li>
                                            ...
                                            body && body.map((result) => {
                                                return (
                                                    <tr
                                                        ...
                                                        onDoubleClick={() => history.push(`/credit-monitoring/branch/purpose/view/${get(result, "loan.id")}`)}
                                                    >

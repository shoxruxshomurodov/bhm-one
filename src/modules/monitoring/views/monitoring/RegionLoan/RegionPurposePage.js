...
function RegionPurposePage(props) {
    const {t} = props;
                ...
                <div className={"d-flex flex fixed-content"}>
                    <Aside title={t("Region Purpose")}>
                        <ul className="nav">
                            ...
                            {/*        <span className="nav-badge"><b className="badge badge-sm badge-pill gd-danger">{get(meta,"purposive.newCount")}</b></span>*/}
                            {/*    </a>*/}
                            {/*</li>*/}
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-info">{get(meta,"purposive.completedCount")}</b></span>
                                </a>
                            </li>
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-danger">{get(meta,"purposive.refusedCount")}</b></span>
                                </a>
                            </li>
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-success">{get(meta,"purposive.confirmedCount")}</b></span>
                                </a>
                            </li>
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-danger">{get(meta,"purposive.expiredCount")}</b></span>
                                </a>
                            </li>
                            ...
                            >
                                <a>
                                    ...
                                    <span className="nav-badge"><b className="badge badge-sm badge-pill gd-primary">{get(meta,"purposive.allCount")}</b></span>
                                </a>
                            </li>
                        </ul>
                    </Aside>
                    <div className={"d-flex flex mt-3"} id={"content-body"}>
                        <div className={"d-flex flex-column flex"} id={"user-list"}>
                            ...
                            {isFetched ?
                                <>
                                    <TemplateTable
                                        head={['ID', t("Client type"), t('Client'), t("Employee"), t('Product name'), t('Summ'), t("Percentage"), t('Open date'), t("Closed date"), t("Location"), t("Status")]}>
                                        {
                                            body && body.map((result) => {
                                                return (
                                                    <tr
                                                        ...
                                                        onDoubleClick={() => history.push(`/credit-monitoring/region/purpose/view/${get(result, "loan.id")}`)}
                                                    >
...
const mapStateToProps = (state) => {
    return {
        drawToRender: get(state, "normalize.data.branch-purpose-loans.result", []),
        isFetched: get(state, "normalize.data.branch-purpose-loans.isFetched", false),
        meta: get(state, "normalize.data.branch-purpose-loans.result._meta", []),
...
const mapDispatchToProps = (dispatch) => {
    return {
        callRenderTrigger: () => {
            const storeName = "branch-purpose-loans";
            dispatch({

...
function RegionContinuousPage(props) {
    const {t} = props;
        ...
        <>
            <div className={"page-content mt-2"} id={"page-content"}>
                <div className={"d-flex flex fixed-content"}>
                    <Aside title={t("Region Continuous")}>
                        <ul className="nav">
                            ...
                            {/*        <span className="nav-badge"><b className="badge badge-sm badge-pill gd-danger">{get(meta,"continuous.newCount")}</b></span>*/}
                            {/*    </a>*/}
                            {/*</li>*/}
                                            ...
                                            body && body.map((result) => {
                                                return (
                                                    <tr
                                                        ...
                                                        onDoubleClick={() => history.push(`/credit-monitoring/region/continuous/view/${get(result, "loan.id")}`)}
                                                    >
...
export default withTranslation("bhm_one")(connect(
    mapStateToProps,
    mapDispatchToProps
)(withRouter(RegionContinuousPage)));

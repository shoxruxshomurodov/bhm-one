...
import ColumnChart from "../my-bonus/components/ColumnChart";
import moment from "moment";
import { useParams } from "react-router-dom";

function EmployeesBonusPageView(props) {
  const { id } = useParams();
  const { t } = props;
...
export default withTranslation("bhm_one")(EmployeesBonusPageView);

...
function RegionLoanDrawer(props) {
                            ...
                            <div className="mx-3">
                                <div className="py-4 d-sm-flex no-shrink b-b">
                                    ...
                                    <div className="px-sm-4 my-3 my-sm-0 flex"><h2
                                        ...
                                        <div className="my-3"><a data-pjax-state><strong>{t("Сумма")}</strong> <span
...
const mapStateToProps = (state) => {
    return {
        ...
        isFetched: get(state, "normalize.data.region-loans-view-id.isFetched", false),
        loans: get(state, 'normalize.data.region-loans-view-id.result', {}),
    }
}
const mapDispatchToProps = (dispatch) => {
    return {
        getLoanTrigger: () => {
            const storeName = 'region-loans-view-id';
            dispatch({
...
export default withTranslation("bhm_one")(connect(mapStateToProps, mapDispatchToProps)(withRouter(RegionLoanDrawer)));

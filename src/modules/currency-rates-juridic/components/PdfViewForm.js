                ...
                <div className="col-12 doc">
                        ...
                        <div className="col-4">
                            <h2 className="doc__right">
                                ...
                                {order_date.slice(0, 4)}
                                 YIL {Utils.removeDayStart(order_date.slice(8, 10))} - {Utils.getMonthName(order_date.slice(5, 7))}DAGI <br/> {order_number} - SONLI <br/>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <h2 className={'doc__title'}> XO'JALIK SUBYEKTLARI UCHUN <br/> VALYUTA KURSLARI</h2>
                            <p className={'doc__text'}>(xo'jalik subyektlarining chet el valyutasini sotib olish va sotish kurslari)</p>
                        </div>
                    </div>
                    ...
                    <div className="row mt-3">
                        <div className="col-9">
                            ...
                            {isEqual(status, 1) &&
                            <div className={'d-flex align-items-center'}><span className={'sign-text mr-3'}>Подписано:</span> <span>{`${get(employee,'post_name')}: ${get(employee,'full_name')}`}</span></div>
                            }
                            {isEqual(status, 0) &&

...
const mapStateToProps = (state) => {
	return {
		drawToRender: get(state, "normalize.data.problem_credits_one.result", []),
		...
		isFetched: get(state, 'normalize.data.problem_credits_one.isFetched', false),
		meta: get(state, "normalize.data.problem_credits_one.result._meta", {}),
...
const mapDispatchToProps = (dispatch) => {
	return {
      ...
      const storeName = "problem_credits_one";

    ...
    <Tabs defaultActiveKey="2" className="pl-2">
      ...
      <TabPane tab="Файллар" key="4">
        ...
        <div
          ...
          >
            <b className="mb-2">Мониторинг учун юборилган файллар</b>
            <div>
              {" "}
              {monitoringFiles &&
            ...
            {isEmpty(monitoringFiles) && (
              <p className="text-center">Файл юкланмаган</p>
            )}
          </div>
          <div
            className="card"
            style={{ maxHeight: "600px", overflow: "auto" }}
          >
            <b className="mb-2">Мақсадли/Мақсадсиз учун юборилган файллар</b>
            <div>
              {" "}
              {intentionalFiles &&
                intentionalFiles.map((file) => {
                  return (
                    <div
                      className="d-flex align-items-center cursor-pointer"
                      style={{ flexDirection: "row" }}
          ...
          <div
            ...
            style={{ maxHeight: "600px", overflow: "auto" }}
          >
            <b className="mb-2">Юридик учун юборилган файллар</b>
            <div>
              {juridicFiles &&
                juridicFiles.map((file) => {
                  return (
                    <div
                      className="d-flex  align-items-center cursor-pointer"
                      style={{ flexDirection: "row" }}
          ...
          <div
            ...
            style={{ maxHeight: "600px", overflow: "auto" }}
          >
            <b className="mb-2">Суд Жараёни учун юборилган файллар</b>
            <div>
              {judgeFiles &&
                judgeFiles.map((file) => {
                  return (
      ...
      <TabPane tab="История" key="5">
        {stepHistories &&
          stepHistories.map((history) => {
            return (
              <div className="timeline mb-4">
                <div className="tl-item">
                  <div className="tl-dot" style={{ width: "200px" }}>
                    <a
                      className="tl-author"
                      style={{
                        width: "200px",
                    ...
                    >
                      <h5
                        className="badge gd-info p-1"
                        style={{ width: "95%" }}
                      >
                        {" "}
                        {get(history, "categoryOption.title")}
                      </h5>
                    </a>
                  </div>
                  <div className="tl-content">
                    <div className>{get(history, "fullName")}</div>
                    <div className>{get(history, "comment")}</div>
                    <div
        ...
        {isEmpty(stepHistories) && <p className="text-center">История йўқ</p>}
      </TabPane>
    </Tabs>
  );
};

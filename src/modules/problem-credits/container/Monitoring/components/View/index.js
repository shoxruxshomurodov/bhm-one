  ...
  return {
    callToRender: ({ loan_id }) => {
      ...
      dispatch({
        ...
        payload: {
          url: "/problem-credit/monitoring/view",
          config: {
            params: {
              include:
                "client_view,loanState,bank,credits,kpi,statusList,account_view,creditType,loanState.stateStatus,credits.bank,credits.creditType,loanEmployees,myLoanStatus,files,loanEmployees.user,juridicFiles,intentionalFiles,categoryOption,stepHistories,judgeFiles,monitoringTimer,monitoringFiles",
              loan_id
            }
          },
          scheme,

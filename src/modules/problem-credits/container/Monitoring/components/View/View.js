...
const View = (props) => {
  ...
  const UploadFiles = () => {
    ...
    return request
      .post(`/problem-credit/monitoring/file-upload`, formData)
      .then(() => {
                  ...
                  <div className="row no-gutters">
                    ...
                    >
                      <FlipClock
                        ...
                        count_to={
                          (isNil(get(monitoringTimer, "expire_date")) || get(monitoringTimer, "is_completed"))
                            ? moment().format("YYYY-MM-DD hh:mm:ss")
                            : get(monitoringTimer, "expire_date")
                        }
                      />
                    </div>
                  </div>

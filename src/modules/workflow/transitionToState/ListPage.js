...
export default function ListPage() {
  ...
  const paginationCurrent = useSelector((state) =>
    get(
      state,
      "normalize.data.transition-to-state-list.result._meta.currentPage"
    )
  );
  const paginationPageSize = useSelector((state) =>
    get(state, "normalize.data.transition-to-state-list.result._meta.perPage")
  );
  const paginationTotal = useSelector((state) =>
    get(
      state,
      "normalize.data.transition-to-state-list.result._meta.totalCount"
    )
  );
  const pagination = {
  ...
  const getData = () => {
    ...
    dispatch({
      ...
      payload: {
        storeName: "transition-to-state-list",
        entityName: "transtionToState",
      },
    });
    ...
    dispatch({
      ...
      payload: {
        url: `/workflow/transition-to-state`,
        config: {
          params: {
            "per-page": perPage,
            page: page,
        ...
        scheme: { data: [TransitionToStateScheme] },
        storeName: "transition-to-state-list",
        entityName: "transtionToState",
      },
    });
  ...
  return (
    <div className="page-content">
      <Hat name="В процессе" desc="Поиск, создание, изменение и удаление" />

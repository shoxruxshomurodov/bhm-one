...
export default function ListPage() {
       ...
       const paginationCurrent = useSelector((state) =>
           get(state, "normalize.data.workflow-process-list.result._meta.currentPage")
       );
       const paginationPageSize = useSelector((state) =>
           get(state, "normalize.data.workflow-process-list.result._meta.perPage")
       );
       const paginationTotal = useSelector((state) =>
           get(state, "normalize.data.workflow-process-list.result._meta.totalCount")
       );
       const pagination = {
       ...
       const deleteData = (id) => {
              ...
              const storeName = "workflow-process-delete";
                             ...
                             <Table
                                 ...
                                 columns={[
                                        ...
                                        },
                                        {
                                               title: "Name",
                                               render: (data) => {
                                                      return <Link to={`/workflow/processes/view/${get(data,"id")}`}>
                                                             {get(data,'name')}
                                                      </Link>
                                               },
                                               sorter: true,

...
export function CreateContainer({setOpenCreateForm, monitoring_process_id, getAll}) {
       ...
       const create = (attributes, formMethods) => {
              const url = "/monitoring/process-tab";
              const storeName = "workflow-tab-create";
       ...
       return (
           <CreateForm create={create} state_list={resultData} />
       );
}
